...
INSERT INTO emotion_card (sender_id, receiver_id, house_work_id, disappointment, created_date, is_read)
VALUES (1, 2, 3, '조금 더 신경 써주세요', '2025-08-14T10:30:00', false),
       (1, 3, 4, null, '2025-08-14T10:32:15', false),
       (1, 4, 8, '시간 약속을 지켜주세요', '2025-08-14T10:35:45', true),
       (2, 1, 3, null, '2025-08-14T10:30:00', false),
       (3, 1, 4, '다음엔 더 깨끗하게 부탁해요', '2025-08-14T10:30:00', true),
       (4, 1, 8, '좀 더 잘 해봅시다', '2025-08-14T10:30:00', true);
